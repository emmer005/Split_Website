  ...
  return (
    <>
      <section className=" space-y-20 mt-16">
        ...
        <div className="w-[80vw] mx-auto  flex flex-col gap-10">
        ...
        <div className="flex w-[80vw] mx-auto flex-col gap-20">
          <div className="grid gap-4 w-5/6">
            ...
            <small>
              ...
              quis fugiat deserunt, recusandae nesciunt doloremque libero ea,
              dolores ipsum aut dolorum! Laborum, necessitatibus! Facere
              reiciendis quae minus porro illum facilis.
            </small>
          </div>
